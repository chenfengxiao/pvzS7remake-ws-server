"use strict";
    ...
    const PLANT_RULES = {
      ...
      threepeater: {
        ...
        tag: "6豆/概率大招",
        desc: "每1.8s三行各2豆；概率90/120豆大招，5阶僵尸越近开大率越高。"
      },
      seashroom: {
        name: "海蘑菇",
        emoji: "🪼",
      ...
      melon: {
        ...
        tag: "连射30-60%/增大/金瓜",
        desc: "每轮投出原版西瓜；连射率30%/45%/60%，连射间隔0.325秒且可递归继续连射；0.5%金瓜无限弹跳并秒杀。3阶起每次以75%概率连续增大，直击每次+40、溅射每次+10；5阶至少增大1次，单瓜增大达到3次即变为2格西瓜大炮。"
      },
      gatling: {
        name: "机枪射手",
        emoji: "🔫🌿",
